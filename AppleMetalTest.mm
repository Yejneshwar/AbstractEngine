...
// Returns full path to a file in the Resources folder

//std::string getResourcePath(const std::string& filename) {
//    NSString *name = [NSString stringWithUTF8String:filename.c_str()];
//    NSString *resourcePath = [[NSBundle mainBundle] pathForResource:[name stringByDeletingPathExtension]
...
{
    std::cout << getResourcePath("FontAtlas.png") << std::endl;
    std::cout << getResourcePath("Resource/Textures/FontAtlas.png") << std::endl;
    std::cout << getResourcePath("./Resource/Textures/FontAtlas.png") << std::endl;
    std::cout << getResourcePath("/Resource/Textures/FontAtlas.png") << std::endl;
